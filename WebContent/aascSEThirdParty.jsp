...
/*==========================================================================+
|  DESCRIPTION                                                              |
|    JSP aascSEThirdParty for displaying the Third Party related       | 
|    information                                                            |
|    Author Joseph                                                     |
|    Version   1.1                                                          |                                                                            
|    Creation 22/02/2016                                                     |
...
<%!  private static Logger logger=AascLogger.getLogger("aascSEThirdParty"); %>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" />
   ...
   <body class="gradientbg" style="height:100%" onLoad="fill();displayInfo();setTpCountryName()">
    ...
    <%  
      ...
      {
          logger.severe("exception in aaascSEThirdParty.jsp while creating object"+e.getMessage());
      }
    %>
    <script>
      ...
      function fill()
      {
        <%
          ...
          {
            logger.severe("exception in the fill() method in the aascSEThirdParty jsp"+e.getMessage());
