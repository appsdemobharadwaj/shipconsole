...
<%/*==============================================================================================+
|  DESCRIPTION                                                                                    |
|    JSP to Save ShipExec International Shipment options                                        |
|    Author joseph                                                                            |
|    Version   1                                                                                  |                                                                              
...
<html>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" />
   ...
   <!-- <style type="text/css"> 
    ...
    <link href="kendo.common-material.min.css" rel="stylesheet" />
        ...
        <title><s:property value="getText('ShipExecInternationalShipments')"/></title>
        
        <link type="text/css" rel="stylesheet" href="aasc_ss.css">
        <link type="text/css" rel="stylesheet" href="aasc_index.css"/>
        <script type="text/javascript" src="aascShipExecIntlShipment_js.js"></script>
    ...
    <table width="100%"  align="center" style="padding:0px 0px 0px 0px;">
        <tr>
            <td class="international" align="center">
 ...
 System.out.println("upsMode:22:"+upsMode);
        pageContext.setAttribute("upsMode",upsMode);
    ...
    %>
    <br/>
    <s:form method="POST" name="aascShipExecIntlShipmentsForm" action="AascShipExecIntlShipAction" onsubmit="return saveDetails()">
        ...
        <s:set name="addCommDisabled" value="%{''}"/>
          ...
          <s:set name="upsMode" value="%{#attr.upsMode}"/>
        <s:hidden name="upsModeHid" id="upsModeHid" value="%{#upsMode}"/>
