/*==========================================================================+
|  DESCRIPTION                                                              |
|    javascript file for the aascCreateCustomer.jsp validation              |
|    Author Suman Gunnda                                                    |
|    Version   1.1                                                          |
|    Creation 25/07/2014           
* 05/03/2015    Sanjay & Khaja Added code for new UI changes.|
| 09/03/2015    Sunanda Merged the changes for customer creation validations
                and removed Profile options related data
  28/10/2015    Suman G     Added code to implement Transaction Count in Update Customer.
  24/02/2016    Suman G     Added code for new Transaction Management design.
  02/03/2016    Suman G     Commented code to fix #4351
+===========================================================================*/
//Global variables
...
function save()
{
var companyName = trimStr(document.CreateCustomerForm.companyName.value);
    var contactName = trimStr(document.CreateCustomerForm.contactName.value);
    var addrLine1 = trimStr(document.CreateCustomerForm.addressLine1.value);
    var addrLine2 = trimStr(document.CreateCustomerForm.addressLine2.value);
    var City = trimStr(document.CreateCustomerForm.city.value);
    var state = trimStr(document.CreateCustomerForm.state.value);
    var postalcode = document.CreateCustomerForm.postalCode.value;
    var country = trimStr(document.CreateCustomerForm.countryCode.value);
    var phoneNo = trimStr(document.CreateCustomerForm.phoneNumber.value);
    //var pricing = trimStr(document.CreateCustomerForm.estPkgTransc.value);
//    var tranCount = trimStr(document.CreateCustomerForm.transactionCount.value);
//    var licenseStartDt = document.CreateCustomerForm.licenseStartDateText.value;
//    var licenseEndDt = document.CreateCustomerForm.licenseEndDateText.value;
    // var url = document.CreateCustomerForm.url.value;
    //var authUserName = document.CreateCustomerForm.authUserName.value;
    //var authPw = document.CreateCustomerForm.authPassword.value;
    var email = trimStr(document.CreateCustomerForm.emailAddress.value);
    var status = trimStr(document.CreateCustomerForm.status.value);
    var firstName = trimStr(document.CreateCustomerForm.firstName.value);
    //    var userName = document.CreateCustomerForm.userName.value;
    //    var pwd = document.CreateCustomerForm.password.value;
    //    var pwd1 = document.CreateCustomerForm.password1.value;
    var licenseStartDateText=document.CreateCustomerForm.licenseStartDateText.value;
//    var licenseEndDateText=document.CreateCustomerForm.licenseEndDateText.value;
    var url_reg=/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/|www\.)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/
    var con_name=/^[a-zA-Z]\w*( \w+)*$/; //Added by Shiva
    var cloudLabelPath=document.CreateCustomerForm.CloudLabelPath.value;
    ...
    if(companyName.length == 0 || companyName.length == null ){
        ...
        alert("Company name cannot be greater than 35 char");
        document.CreateCustomerForm.companyName.focus();
        return false;
    }
   ...
   if(onlyNum(companyName))
    ...
    if(contactName.length == 0 || contactName.length == null ){
        ...
        document.CreateCustomerForm.contactName.focus();
        return false;
    }
    else if(contactName.length > 35){
        alert("Contact Name cannot be greater than 35 char");
        document.CreateCustomerForm.contactName.focus();
        return false;
    }
    ...
    else if(isSomeSpclCharInName(contactName)){
        alert("Contact Name cannot have special charater other than (-,/,&)");
        document.CreateCustomerForm.contactName.focus();
        return false;
    }
    ...
    if(addrLine1.length == 0 || addrLine1.length == null ){
        ...
        document.CreateCustomerForm.addressLine1.focus();
        return false;
    }
    else if(addrLine1.length > 36){
        alert("Address Line 1 name cannot be greater than 35 char");
        document.CreateCustomerForm.addressLine1.focus();
        return false;
    }
    ...
    if(addrLine2.length > 36){
        alert("Address Line 2 name cannot be greater than 35 char");
        document.CreateCustomerForm.addressLine2.focus();
        return false;
    }
    ...
    if(City.length == 0 || City.length == null ){
        ...
        document.CreateCustomerForm.city.focus();
        //document.CreateCustomerForm.city.focus();
        return false;
    }
    ...
    if(state.length == 0 || state.length == null ){
        ...
        document.CreateCustomerForm.state.focus();
        return false;
    }
    ...
    if(postalcode.length == 0 || postalcode.length == null ){
        ...
        document.CreateCustomerForm.postalCode.focus();
        return false;
    }
    ...
    // Below if condition added by Suman Gunda for select country
    if(country == 'Select'){
        alert("Select Country Name");
        document.CreateCustomerForm.countryCode.focus();
        return false;
    }
    
    if(phoneNo.length == 0 || phoneNo.length == null ){
        alert("Please enter PhoneNumber ");
        document.CreateCustomerForm.phoneNumber.focus();
        return false;
    }
    ...
    // Below else if condition added by Suman for Checking Phone No.
    else if(isPhnNoChar(phoneNo))
    {
     ...
     if(email.length == 0 || email.length == null ){
        ...
        document.CreateCustomerForm.emailAddress.focus();
        return false;
    }
...
//    if(pricing == 'TransactionCount'){
//        if(tranCount.length == 0 ){
//            alert("Transaction Count cannot be empty if pricing  is Transaction Count.");   
//            document.CreateCustomerForm.transactionCount.focus();
//            return false;
//        }
//        else if(tranCount.length > 7){
//            alert("Transaction Count length cannot be greater than 7.");   
//            document.CreateCustomerForm.transactionCount.focus();
//            return false;
//        }
...
//    }
    ...
    // Below validatioDateFormat and compareDates conditions added by Suman
//    if(pricing == 'Duration'){
        if(licenseStartDateText == '')
        {
            alert('Please enter Customer Start Date');
            return false;
        }
//        if(!validateDateFormat(licenseStartDateText)){  
//            alert("Enter License Start Date in 'yyyy-mm-dd' format");
//            document.CreateCustomerForm.licenseStartDateText.focus();
//            return false;
//        }
...
//            document.CreateCustomerForm.licenseEndDateText.focus();
//            return false;
//        }
...
//    }
     if(firstName.length == 0 || firstName.length == null ){
        ...
        document.CreateCustomerForm.firstName.focus();
    return false;
  }
   ...
   if(CloudLabelPathTemp.length == 0 || CloudLabelPathTemp.length == null )
  {
        ...
        document.CreateCustomerForm.CloudLabelPath.focus();
        return false;    
    }   
    if(document.CreateCustomerForm.SaveButtonId.value == "0"){
  //alert('entered IF');
    document.CreateCustomerForm.SaveButtonId.value="1";
    return true;
  }
    else{
  // alert('entered ELSE');
...
function validateFields()
{
    ...
    var country = trimStr(document.CreateCustomerForm.countryCode.value);
    var phoneNo = trimStr(document.CreateCustomerForm.phoneNumber.value);
//    var pricing = trimStr(document.CreateCustomerForm.transactionType.value);
//    var tranCount = trimStr(document.CreateCustomerForm.transactionCount.value);
//    var licenseStartDt = document.CreateCustomerForm.licenseStartDateText.value;
//    var licenseEndDt = document.CreateCustomerForm.licenseEndDateText.value;
//    var url = document.CreateCustomerForm.url.value;
...
//         
    ...
    if(cloudLabelPath.length == 0 || cloudLabelPath.length == null )
    {
        alert("Please enter cloud label path");
        document.CreateCustomerForm.CloudLabelPath.focus();
        return false;    
...
function isSomeSpclChar(variable){
    ...
    for (var i = 0; i < variable.length; i++) {
        if (iChars.indexOf(variable.charAt(i)) != -1 || variable.match('"')) {
            return true;
        }
    }
}
...
//Suman added below methods for create customer validations for Phone Number
...
//Suman added below methods for Validate Dates for create customer
...
{
    document.CreateCustomerForm.companyName.value='';
    document.CreateCustomerForm.contactName.value='';
    document.CreateCustomerForm.addressLine1.value='';
    document.CreateCustomerForm.addressLine2.value='';
    document.CreateCustomerForm.city.value='';
    document.CreateCustomerForm.state.value='';
    document.CreateCustomerForm.postalCode.value='';
    document.CreateCustomerForm.countryCode.value='Select';
    document.CreateCustomerForm.phoneNumber.value='';
//    document.CreateCustomerForm.transactionType.value='Duration';
//    document.CreateCustomerForm.transactionCount.value='';
//    document.CreateCustomerForm.licenseStartDateText.value='';
//    document.CreateCustomerForm.licenseEndDateText.value='';
    //     document.CreateCustomerForm.url.value='';
    //     document.CreateCustomerForm.authUserName.value='';
    //    document.CreateCustomerForm.authPassword.value='';
    document.CreateCustomerForm.emailAddress.value='';
    document.CreateCustomerForm.status.value='N';
    //     document.CreateCustomerForm.userName.value='';
    document.CreateCustomerForm.firstName.value='';
    document.CreateCustomerForm.lastName.value='';
    //     document.CreateCustomerForm.password.value='';
    //     document.CreateCustomerForm.password1.value='';
    document.CreateCustomerForm.CloudLabelPath.value='';
    document.CreateCustomerForm.companyName.focus();
}
...
document.CreateCustomerForm.originalTotal.value=(document.CreateCustomerForm.estPkgTransc.value)*(document.CreateCustomerForm.originalCost.value);

    if(document.CreateCustomerForm.discount.value!='')
    {
    document.CreateCustomerForm.discountTotal.value=(document.CreateCustomerForm.originalTotal.value)-((document.CreateCustomerForm.originalTotal.value)*((document.CreateCustomerForm.discount.value)/100));
    }


}

function calcDiscountCost(){
...
function load()
{
    document.getElementById('invoiceTypeId').checked = true;
    
//    hideFields(document.getElementById('invoiceTypeId').value);
