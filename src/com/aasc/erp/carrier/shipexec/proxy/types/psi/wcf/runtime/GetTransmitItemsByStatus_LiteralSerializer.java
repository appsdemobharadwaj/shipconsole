...
public class GetTransmitItemsByStatus_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    public GetTransmitItemsByStatus_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public GetTransmitItemsByStatus_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetTransmitItemsByStatus instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetTransmitItemsByStatus();
        ...
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_status_QNAME))) {
                ...
                member = myns2__int__int_Int_Serializer.deserialize(ns1_status_QNAME, reader, context);
                requiredElements.remove("status");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setStatus(((Integer)member).intValue());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetTransmitItemsByStatus instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetTransmitItemsByStatus)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2__int__int_Int_Serializer.setNullable( false );
        myns2__int__int_Int_Serializer.serialize(new Integer(instance.getStatus()), ns1_status_QNAME, null, writer, context);
    }
}
