...
public class NameAddressValidationCandidate_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_isCassCertified_QNAME = new QName("http://PSI.Wcf", "isCassCertified");
    private static final QName ns1_isResComValid_QNAME = new QName("http://PSI.Wcf", "isResComValid");
    
    public NameAddressValidationCandidate_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public NameAddressValidationCandidate_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.NameAddressValidationCandidate instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.NameAddressValidationCandidate();
        ...
        for (int memberIndex = 0; memberIndex <18; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_isCassCertified_QNAME))) {
                myns2__boolean__java_lang_Boolean_Boolean_Serializer.setNullable( false );
                member = myns2__boolean__java_lang_Boolean_Boolean_Serializer.deserialize(ns1_isCassCertified_QNAME, reader, context);
                requiredElements.remove("isCassCertified");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setIsCassCertified((java.lang.Boolean)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_isResComValid_QNAME))) {
                myns2__boolean__java_lang_Boolean_Boolean_Serializer.setNullable( false );
                member = myns2__boolean__java_lang_Boolean_Boolean_Serializer.deserialize(ns1_isResComValid_QNAME, reader, context);
                requiredElements.remove("isResComValid");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setIsResComValid((java.lang.Boolean)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.NameAddressValidationCandidate instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.NameAddressValidationCandidate)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getIsCassCertified() != null) {
            myns2__boolean__java_lang_Boolean_Boolean_Serializer.setNullable( false );
            myns2__boolean__java_lang_Boolean_Boolean_Serializer.serialize(instance.getIsCassCertified(), ns1_isCassCertified_QNAME, null, writer, context);
        }
        if (instance.getIsResComValid() != null) {
            myns2__boolean__java_lang_Boolean_Boolean_Serializer.setNullable( false );
            myns2__boolean__java_lang_Boolean_Boolean_Serializer.serialize(instance.getIsResComValid(), ns1_isResComValid_QNAME, null, writer, context);
        }
    }
}
