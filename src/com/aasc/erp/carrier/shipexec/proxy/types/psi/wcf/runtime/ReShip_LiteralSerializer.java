...
public class ReShip_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_packageToReship_QNAME = new QName("http://PSI.Wcf", "packageToReship");
    ...
    public ReShip_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ReShip_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ReShip instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ReShip();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_packageToReship_QNAME))) {
                myns1_Package__Package_LiteralSerializer.setNullable( false );
                member = myns1_Package__Package_LiteralSerializer.deserialize(ns1_packageToReship_QNAME, reader, context);
                requiredElements.remove("packageToReship");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPackageToReship((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.Package)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ReShip instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ReShip)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPackageToReship() != null) {
            myns1_Package__Package_LiteralSerializer.setNullable( false );
            myns1_Package__Package_LiteralSerializer.serialize(instance.getPackageToReship(), ns1_packageToReship_QNAME, null, writer, context);
        }
