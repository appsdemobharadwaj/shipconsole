...
public class ShipResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_ShipResult_QNAME = new QName("http://PSI.Wcf", "ShipResult");
    ...
    public ShipResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ShipResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipResponse();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_ShipResult_QNAME))) {
                myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.setNullable( false );
                member = myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.deserialize(ns1_ShipResult_QNAME, reader, context);
                requiredElements.remove("ShipResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setShipResult((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentResponse)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getShipResult() != null) {
            myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.setNullable( false );
            myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.serialize(instance.getShipResult(), ns1_ShipResult_QNAME, null, writer, context);
        }
