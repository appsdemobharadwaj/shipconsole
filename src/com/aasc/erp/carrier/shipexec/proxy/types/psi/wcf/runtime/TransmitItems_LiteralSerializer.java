...
public class TransmitItems_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_itemsToTransmit_QNAME = new QName("http://PSI.Wcf", "itemsToTransmit");
    ...
    public TransmitItems_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public TransmitItems_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItems instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItems();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_itemsToTransmit_QNAME))) {
                myns1_ArrayOfString__ArrayOfString_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfString__ArrayOfString_LiteralSerializer.deserialize(ns1_itemsToTransmit_QNAME, reader, context);
                requiredElements.remove("itemsToTransmit");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setItemsToTransmit((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString)member).toArray());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItems instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItems)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getItemsToTransmit() != null) {
            myns1_ArrayOfString__ArrayOfString_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString instanceGetItemsToTransmit_arrayWrapper = (instance.getItemsToTransmit() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString(instance.getItemsToTransmit());
            myns1_ArrayOfString__ArrayOfString_LiteralSerializer.serialize(instanceGetItemsToTransmit_arrayWrapper, ns1_itemsToTransmit_QNAME, null, writer, context);
        }
