...
public class ShipOrderResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_ShipOrderResult_QNAME = new QName("http://PSI.Wcf", "ShipOrderResult");
    ...
    public ShipOrderResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ShipOrderResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipOrderResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipOrderResponse();
        ...
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_ShipOrderResult_QNAME))) {
                myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.setNullable( false );
                member = myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.deserialize(ns1_ShipOrderResult_QNAME, reader, context);
                requiredElements.remove("ShipOrderResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setShipOrderResult((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentResponse)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipOrderResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipOrderResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getShipOrderResult() != null) {
            myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.setNullable( false );
            myns1_ShipmentResponse__ShipmentResponse_LiteralSerializer.serialize(instance.getShipOrderResult(), ns1_ShipOrderResult_QNAME, null, writer, context);
        }
