...
public class AddMachineResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_AddMachineResult_QNAME = new QName("http://PSI.Wcf", "AddMachineResult");
    ...
    public AddMachineResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public AddMachineResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddMachineResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddMachineResponse();
        ...
        requiredElements.add("AddMachineResult");
        requiredElements.add("profile_id");
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            elementName = reader.getName();
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_AddMachineResult_QNAME))) {
                myns2__boolean__boolean_Boolean_Serializer.setNullable( false );
                member = myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_AddMachineResult_QNAME, reader, context);
                requiredElements.remove("AddMachineResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setAddMachineResult(((Boolean)member).booleanValue());
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddMachineResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddMachineResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2__boolean__boolean_Boolean_Serializer.setNullable( false );
        myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isAddMachineResult()), ns1_AddMachineResult_QNAME, null, writer, context);
        myns2__int__int_Int_Serializer.setNullable( false );
