...
public class PackRateRequest_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_package_request_QNAME = new QName("http://PSI.Wcf", "package_request");
    ...
    private static final QName ns1_ArrayOfShippingWarehouse_TYPE_QNAME = new QName("http://PSI.Wcf", "ArrayOfShippingWarehouse");
    private CombinedSerializer myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer;
    private static final QName ns1_required_delivery_date_QNAME = new QName("http://PSI.Wcf", "required_delivery_date");
    ...
    public PackRateRequest_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PackRateRequest_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfShippingWarehouse.class, ns1_ArrayOfShippingWarehouse_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateRequest instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateRequest();
        ...
        for (int memberIndex = 0; memberIndex <14; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_package_request_QNAME))) {
                myns1_PackageRequest__PackageRequest_LiteralSerializer.setNullable( false );
                member = myns1_PackageRequest__PackageRequest_LiteralSerializer.deserialize(ns1_package_request_QNAME, reader, context);
                requiredElements.remove("package_request");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPackage_request((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackageRequest)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_warehouses_QNAME))) {
                myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer.deserialize(ns1_warehouses_QNAME, reader, context);
                requiredElements.remove("warehouses");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setWarehouses((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfShippingWarehouse)member).toArray());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_required_delivery_date_QNAME))) {
                myns2_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.setNullable( false );
                member = myns2_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.deserialize(ns1_required_delivery_date_QNAME, reader, context);
                requiredElements.remove("required_delivery_date");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setRequired_delivery_date((java.util.Calendar)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateRequest instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateRequest)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPackage_request() != null) {
            myns1_PackageRequest__PackageRequest_LiteralSerializer.setNullable( false );
            myns1_PackageRequest__PackageRequest_LiteralSerializer.serialize(instance.getPackage_request(), ns1_package_request_QNAME, null, writer, context);
        }
        if (instance.getWarehouses() != null) {
            myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfShippingWarehouse instanceGetWarehouses_arrayWrapper = (instance.getWarehouses() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfShippingWarehouse(instance.getWarehouses());
            myns1_ArrayOfShippingWarehouse__ArrayOfShippingWarehouse_LiteralSerializer.serialize(instanceGetWarehouses_arrayWrapper, ns1_warehouses_QNAME, null, writer, context);
        }
        if (instance.getRequired_delivery_date() != null) {
            myns2_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.setNullable( false );
            myns2_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.serialize(instance.getRequired_delivery_date(), ns1_required_delivery_date_QNAME, null, writer, context);
        }
    }
}
