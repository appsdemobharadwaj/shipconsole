...
public class PackResponseType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_PackResult_QNAME = new QName("http://PSI.Wcf", "PackResult");
    ...
    public PackResponseType_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PackResponseType_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponseType instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponseType();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_PackResult_QNAME))) {
                myns1_PackResponse__PackResponse_LiteralSerializer.setNullable( false );
                member = myns1_PackResponse__PackResponse_LiteralSerializer.deserialize(ns1_PackResult_QNAME, reader, context);
                requiredElements.remove("PackResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPackResult((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponse)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponseType instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponseType)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPackResult() != null) {
            myns1_PackResponse__PackResponse_LiteralSerializer.setNullable( false );
            myns1_PackResponse__PackResponse_LiteralSerializer.serialize(instance.getPackResult(), ns1_PackResult_QNAME, null, writer, context);
        }
