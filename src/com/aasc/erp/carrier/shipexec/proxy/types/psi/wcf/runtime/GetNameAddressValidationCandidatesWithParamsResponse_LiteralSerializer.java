...
public class GetNameAddressValidationCandidatesWithParamsResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_GetNameAddressValidationCandidatesWithParamsResult_QNAME = new QName("http://PSI.Wcf", "GetNameAddressValidationCandidatesWithParamsResult");
    ...
    public GetNameAddressValidationCandidatesWithParamsResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public GetNameAddressValidationCandidatesWithParamsResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNameAddressValidationCandidatesWithParamsResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNameAddressValidationCandidatesWithParamsResponse();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_GetNameAddressValidationCandidatesWithParamsResult_QNAME))) {
                myns1_ArrayOfNameAddressValidationCandidate__ArrayOfNameAddressValidationCandidate_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfNameAddressValidationCandidate__ArrayOfNameAddressValidationCandidate_LiteralSerializer.deserialize(ns1_GetNameAddressValidationCandidatesWithParamsResult_QNAME, reader, context);
                requiredElements.remove("GetNameAddressValidationCandidatesWithParamsResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setGetNameAddressValidationCandidatesWithParamsResult((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfNameAddressValidationCandidate)member).toArray());
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNameAddressValidationCandidatesWithParamsResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNameAddressValidationCandidatesWithParamsResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getGetNameAddressValidationCandidatesWithParamsResult() != null) {
            myns1_ArrayOfNameAddressValidationCandidate__ArrayOfNameAddressValidationCandidate_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfNameAddressValidationCandidate instanceGetGetNameAddressValidationCandidatesWithParamsResult_arrayWrapper = (instance.getGetNameAddressValidationCandidatesWithParamsResult() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfNameAddressValidationCandidate(instance.getGetNameAddressValidationCandidatesWithParamsResult());
            myns1_ArrayOfNameAddressValidationCandidate__ArrayOfNameAddressValidationCandidate_LiteralSerializer.serialize(instanceGetGetNameAddressValidationCandidatesWithParamsResult_arrayWrapper, ns1_GetNameAddressValidationCandidatesWithParamsResult_QNAME, null, writer, context);
        }
