...
public class VoidPackagesByGlobalMsnListResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_VoidPackagesByGlobalMsnListResult_QNAME = new QName("http://PSI.Wcf", "VoidPackagesByGlobalMsnListResult");
    ...
    public VoidPackagesByGlobalMsnListResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public VoidPackagesByGlobalMsnListResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnListResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnListResponse();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_VoidPackagesByGlobalMsnListResult_QNAME))) {
                myns1_ArrayOfPackage__ArrayOfPackage_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfPackage__ArrayOfPackage_LiteralSerializer.deserialize(ns1_VoidPackagesByGlobalMsnListResult_QNAME, reader, context);
                requiredElements.remove("VoidPackagesByGlobalMsnListResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setVoidPackagesByGlobalMsnListResult((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackage)member).toArray());
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnListResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnListResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getVoidPackagesByGlobalMsnListResult() != null) {
            myns1_ArrayOfPackage__ArrayOfPackage_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackage instanceGetVoidPackagesByGlobalMsnListResult_arrayWrapper = (instance.getVoidPackagesByGlobalMsnListResult() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackage(instance.getVoidPackagesByGlobalMsnListResult());
            myns1_ArrayOfPackage__ArrayOfPackage_LiteralSerializer.serialize(instanceGetVoidPackagesByGlobalMsnListResult_arrayWrapper, ns1_VoidPackagesByGlobalMsnListResult_QNAME, null, writer, context);
        }
