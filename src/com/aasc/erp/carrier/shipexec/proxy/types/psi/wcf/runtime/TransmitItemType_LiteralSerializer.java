...
public class TransmitItemType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_itemToTransmit_QNAME = new QName("http://PSI.Wcf", "itemToTransmit");
    ...
    public TransmitItemType_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public TransmitItemType_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItemType instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItemType();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_itemToTransmit_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_itemToTransmit_QNAME, reader, context);
                requiredElements.remove("itemToTransmit");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setItemToTransmit((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItemType instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.TransmitItemType)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getItemToTransmit() != null) {
            myns2_string__java_lang_String_String_Serializer.setNullable( false );
            myns2_string__java_lang_String_String_Serializer.serialize(instance.getItemToTransmit(), ns1_itemToTransmit_QNAME, null, writer, context);
        }
