...
public class VoidPackagesByGlobalMsnList implements java.io.Serializable {
    protected long[] msnList;
    ...
    public VoidPackagesByGlobalMsnList() {
    }
    
    public long[] getMsnList() {
        return msnList;
    }
    
    public void setMsnList(long[] msnList) {
