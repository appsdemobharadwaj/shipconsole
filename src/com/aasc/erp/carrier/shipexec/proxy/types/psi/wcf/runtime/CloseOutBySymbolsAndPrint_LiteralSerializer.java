...
public class CloseOutBySymbolsAndPrint_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_closeOutItems_QNAME = new QName("http://PSI.Wcf", "closeOutItems");
    ...
    public CloseOutBySymbolsAndPrint_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public CloseOutBySymbolsAndPrint_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.CloseOutBySymbolsAndPrint instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.CloseOutBySymbolsAndPrint();
        ...
        for (int memberIndex = 0; memberIndex <5; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_closeOutItems_QNAME))) {
                myns1_ArrayOfString__ArrayOfString_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfString__ArrayOfString_LiteralSerializer.deserialize(ns1_closeOutItems_QNAME, reader, context);
                requiredElements.remove("closeOutItems");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setCloseOutItems((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString)member).toArray());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.CloseOutBySymbolsAndPrint instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.CloseOutBySymbolsAndPrint)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getCloseOutItems() != null) {
            myns1_ArrayOfString__ArrayOfString_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString instanceGetCloseOutItems_arrayWrapper = (instance.getCloseOutItems() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfString(instance.getCloseOutItems());
            myns1_ArrayOfString__ArrayOfString_LiteralSerializer.serialize(instanceGetCloseOutItems_arrayWrapper, ns1_closeOutItems_QNAME, null, writer, context);
        }
