...
public class PackRateResponseType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_PackRateResult_QNAME = new QName("http://PSI.Wcf", "PackRateResult");
    ...
    public PackRateResponseType_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PackRateResponseType_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateResponseType instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateResponseType();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_PackRateResult_QNAME))) {
                myns1_PackRateResponse__PackRateResponse_LiteralSerializer.setNullable( false );
                member = myns1_PackRateResponse__PackRateResponse_LiteralSerializer.deserialize(ns1_PackRateResult_QNAME, reader, context);
                requiredElements.remove("PackRateResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPackRateResult((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateResponse)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateResponseType instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRateResponseType)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPackRateResult() != null) {
            myns1_PackRateResponse__PackRateResponse_LiteralSerializer.setNullable( false );
            myns1_PackRateResponse__PackRateResponse_LiteralSerializer.serialize(instance.getPackRateResult(), ns1_PackRateResult_QNAME, null, writer, context);
        }
