...
public class DeleteHistoryItem_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_historyItem_QNAME = new QName("http://PSI.Wcf", "historyItem");
    ...
    public DeleteHistoryItem_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public DeleteHistoryItem_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteHistoryItem instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteHistoryItem();
        ...
        requiredElements.add("historyItem");
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_historyItem_QNAME))) {
                myns2__int__int_Int_Serializer.setNullable( false );
                member = myns2__int__int_Int_Serializer.deserialize(ns1_historyItem_QNAME, reader, context);
                requiredElements.remove("historyItem");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setHistoryItem(((Integer)member).intValue());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteHistoryItem instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteHistoryItem)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2__int__int_Int_Serializer.setNullable( false );
        myns2__int__int_Int_Serializer.serialize(new Integer(instance.getHistoryItem()), ns1_historyItem_QNAME, null, writer, context);
    }
}
