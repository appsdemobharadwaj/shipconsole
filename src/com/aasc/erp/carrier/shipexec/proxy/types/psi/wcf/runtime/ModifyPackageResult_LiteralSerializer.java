...
public class ModifyPackageResult_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_package_QNAME = new QName("http://PSI.Wcf", "package");
    ...
    public ModifyPackageResult_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ModifyPackageResult_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ModifyPackageResult instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ModifyPackageResult();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_msn_QNAME))) {
                ...
                member = myns2__int__java_lang_Integer_Int_Serializer.deserialize(ns1_msn_QNAME, reader, context);
                requiredElements.remove("msn");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setMsn((java.lang.Integer)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_package_QNAME))) {
                myns1_Package__Package_LiteralSerializer.setNullable( false );
                member = myns1_Package__Package_LiteralSerializer.deserialize(ns1_package_QNAME, reader, context);
                requiredElements.remove("package");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.set_package((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.Package)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ModifyPackageResult instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ModifyPackageResult)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getMsn() != null) {
            myns2__int__java_lang_Integer_Int_Serializer.setNullable( false );
            myns2__int__java_lang_Integer_Int_Serializer.serialize(instance.getMsn(), ns1_msn_QNAME, null, writer, context);
        }
        if (instance.get_package() != null) {
            myns1_Package__Package_LiteralSerializer.setNullable( false );
            myns1_Package__Package_LiteralSerializer.serialize(instance.get_package(), ns1_package_QNAME, null, writer, context);
        }
    }
}
