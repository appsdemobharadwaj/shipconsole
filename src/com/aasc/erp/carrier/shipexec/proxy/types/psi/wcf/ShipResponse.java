...
public class ShipResponse implements java.io.Serializable {
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentResponse shipResult;
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.SoxDictionaryItem[] params;
    
    public ShipResponse() {
    }
    
    public com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentResponse getShipResult() {
        return shipResult;
    }
    
    public void setShipResult(com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentResponse shipResult) {
