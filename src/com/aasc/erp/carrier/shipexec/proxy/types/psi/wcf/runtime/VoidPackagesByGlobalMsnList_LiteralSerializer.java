...
public class VoidPackagesByGlobalMsnList_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    public VoidPackagesByGlobalMsnList_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public VoidPackagesByGlobalMsnList_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnList instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnList();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_msnList_QNAME))) {
                ...
                member = myns1_ArrayOfLong__ArrayOfLong_LiteralSerializer.deserialize(ns1_msnList_QNAME, reader, context);
                requiredElements.remove("msnList");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setMsnList((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfLong)member).toArray());
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnList instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.VoidPackagesByGlobalMsnList)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getMsnList() != null) {
            myns1_ArrayOfLong__ArrayOfLong_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfLong instanceGetMsnList_arrayWrapper = (instance.getMsnList() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfLong(instance.getMsnList());
            myns1_ArrayOfLong__ArrayOfLong_LiteralSerializer.serialize(instanceGetMsnList_arrayWrapper, ns1_msnList_QNAME, null, writer, context);
        }
