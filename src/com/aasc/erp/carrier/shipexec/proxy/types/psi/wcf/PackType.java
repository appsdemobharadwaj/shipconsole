...
public class PackType implements java.io.Serializable {
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRequest packRequest;
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.SoxDictionaryItem[] params;
    
    public PackType() {
    }
    
    public com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRequest getPackRequest() {
        return packRequest;
    }
    
    public void setPackRequest(com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRequest packRequest) {
