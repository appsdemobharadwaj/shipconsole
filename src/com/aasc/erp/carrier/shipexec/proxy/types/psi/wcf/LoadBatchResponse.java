...
public class LoadBatchResponse implements java.io.Serializable {
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.BatchRequest loadBatchResult;
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.SoxDictionaryItem[] params;
    
    public LoadBatchResponse() {
    }
    
    public com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.BatchRequest getLoadBatchResult() {
        return loadBatchResult;
    }
    
    public void setLoadBatchResult(com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.BatchRequest loadBatchResult) {
