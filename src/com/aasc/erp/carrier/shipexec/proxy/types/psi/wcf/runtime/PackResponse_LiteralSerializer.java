...
public class PackResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_pack_details_QNAME = new QName("http://PSI.Wcf", "pack_details");
    private static final QName ns1_ArrayOfPackDetail_TYPE_QNAME = new QName("http://PSI.Wcf", "ArrayOfPackDetail");
    private CombinedSerializer myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer;
    
    public PackResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PackResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackDetail.class, ns1_ArrayOfPackDetail_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponse();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_pack_details_QNAME))) {
                myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer.deserialize(ns1_pack_details_QNAME, reader, context);
                requiredElements.remove("pack_details");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPack_details((member == null)? null : ((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackDetail)member).toArray());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPack_details() != null) {
            myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackDetail instanceGetPack_details_arrayWrapper = (instance.getPack_details() == null) ? null : new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ArrayOfPackDetail(instance.getPack_details());
            myns1_ArrayOfPackDetail__ArrayOfPackDetail_LiteralSerializer.serialize(instanceGetPack_details_arrayWrapper, ns1_pack_details_QNAME, null, writer, context);
        }
    }
}
