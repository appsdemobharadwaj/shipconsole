...
public class LoadResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_LoadResult_QNAME = new QName("http://PSI.Wcf", "LoadResult");
    ...
    public LoadResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public LoadResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.LoadResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.LoadResponse();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_LoadResult_QNAME))) {
                myns1_ShipmentRequest__ShipmentRequest_LiteralSerializer.setNullable( false );
                member = myns1_ShipmentRequest__ShipmentRequest_LiteralSerializer.deserialize(ns1_LoadResult_QNAME, reader, context);
                requiredElements.remove("LoadResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setLoadResult((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.ShipmentRequest)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.LoadResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.LoadResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getLoadResult() != null) {
            myns1_ShipmentRequest__ShipmentRequest_LiteralSerializer.setNullable( false );
            myns1_ShipmentRequest__ShipmentRequest_LiteralSerializer.serialize(instance.getLoadResult(), ns1_LoadResult_QNAME, null, writer, context);
        }
