...
public class PackType_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_packRequest_QNAME = new QName("http://PSI.Wcf", "packRequest");
    ...
    public PackType_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PackType_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackType instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackType();
        ...
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_packRequest_QNAME))) {
                myns1_PackRequest__PackRequest_LiteralSerializer.setNullable( false );
                member = myns1_PackRequest__PackRequest_LiteralSerializer.deserialize(ns1_packRequest_QNAME, reader, context);
                requiredElements.remove("packRequest");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPackRequest((com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackRequest)member);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackType instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.PackType)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPackRequest() != null) {
            myns1_PackRequest__PackRequest_LiteralSerializer.setNullable( false );
            myns1_PackRequest__PackRequest_LiteralSerializer.serialize(instance.getPackRequest(), ns1_packRequest_QNAME, null, writer, context);
        }
