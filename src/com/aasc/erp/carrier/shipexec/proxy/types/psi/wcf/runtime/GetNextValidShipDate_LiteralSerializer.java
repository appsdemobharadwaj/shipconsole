...
public class GetNextValidShipDate_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_carrier_QNAME = new QName("http://PSI.Wcf", "carrier");
    private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
    private static final QName ns1_from_date_QNAME = new QName("http://PSI.Wcf", "from_date");
    ...
    public GetNextValidShipDate_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public GetNextValidShipDate_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNextValidShipDate instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNextValidShipDate();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_from_date_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_from_date_QNAME, reader, context);
                requiredElements.remove("from_date");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setFrom_date((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNextValidShipDate instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetNextValidShipDate)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getFrom_date() != null) {
            myns2_string__java_lang_String_String_Serializer.setNullable( false );
            myns2_string__java_lang_String_String_Serializer.serialize(instance.getFrom_date(), ns1_from_date_QNAME, null, writer, context);
        }
