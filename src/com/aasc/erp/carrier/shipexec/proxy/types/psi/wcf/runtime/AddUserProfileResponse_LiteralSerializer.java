...
public class AddUserProfileResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_AddUserProfileResult_QNAME = new QName("http://PSI.Wcf", "AddUserProfileResult");
    ...
    public AddUserProfileResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public AddUserProfileResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddUserProfileResponse instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddUserProfileResponse();
        ...
        requiredElements.add("AddUserProfileResult");
        requiredElements.add("profile_id");
        for (int memberIndex = 0; memberIndex <2; memberIndex++) {
            elementName = reader.getName();
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_AddUserProfileResult_QNAME))) {
                myns2__boolean__boolean_Boolean_Serializer.setNullable( false );
                member = myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_AddUserProfileResult_QNAME, reader, context);
                requiredElements.remove("AddUserProfileResult");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setAddUserProfileResult(((Boolean)member).booleanValue());
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddUserProfileResponse instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.AddUserProfileResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2__boolean__boolean_Boolean_Serializer.setNullable( false );
        myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isAddUserProfileResult()), ns1_AddUserProfileResult_QNAME, null, writer, context);
        myns2__int__int_Int_Serializer.setNullable( false );
