...
public class GetGroupDocuments_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    private static final QName ns1_carrier_QNAME = new QName("http://PSI.Wcf", "carrier");
    private static final QName ns2_string_TYPE_QNAME = SchemaConstants.QNAME_TYPE_STRING;
    private CombinedSerializer myns2_string__java_lang_String_String_Serializer;
    
    public GetGroupDocuments_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public GetGroupDocuments_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetGroupDocuments instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetGroupDocuments();
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetGroupDocuments instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.GetGroupDocuments)obj;
