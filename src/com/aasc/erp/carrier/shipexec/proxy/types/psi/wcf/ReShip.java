...
public class ReShip implements java.io.Serializable {
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.Package packageToReship;
    protected com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.SoxDictionaryItem[] params;
    
    public ReShip() {
    }
    
    public com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.Package getPackageToReship() {
        return packageToReship;
    }
    
    public void setPackageToReship(com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.Package packageToReship) {
        this.packageToReship = packageToReship;
    }
