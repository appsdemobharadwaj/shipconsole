...
public class DeleteTransmitItem_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_itemToDelete_QNAME = new QName("http://PSI.Wcf", "itemToDelete");
    
    public DeleteTransmitItem_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public DeleteTransmitItem_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteTransmitItem instance = new com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteTransmitItem();
        ...
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_itemToDelete_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_itemToDelete_QNAME, reader, context);
                requiredElements.remove("itemToDelete");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setItemToDelete((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteTransmitItem instance = (com.aasc.erp.carrier.shipexec.proxy.types.psi.wcf.DeleteTransmitItem)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getItemToDelete() != null) {
            myns2_string__java_lang_String_String_Serializer.setNullable( false );
            myns2_string__java_lang_String_String_Serializer.serialize(instance.getItemToDelete(), ns1_itemToDelete_QNAME, null, writer, context);
        }
    }
}
