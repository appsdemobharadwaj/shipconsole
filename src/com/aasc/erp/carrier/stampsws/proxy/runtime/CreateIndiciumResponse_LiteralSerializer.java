...
public class CreateIndiciumResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_ImageData_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "ImageData");
    private static final QName ns1_ArrayOfBase64Binary_TYPE_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "ArrayOfBase64Binary");
    private CombinedSerializer myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer;
    
    public CreateIndiciumResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public CreateIndiciumResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", com.aasc.erp.carrier.stampsws.proxy.ArrayOfBase64Binary.class, ns1_ArrayOfBase64Binary_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.CreateIndiciumResponse instance = new com.aasc.erp.carrier.stampsws.proxy.CreateIndiciumResponse();
        ...
        for (int memberIndex = 0; memberIndex <10; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_ImageData_QNAME))) {
                myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer.setNullable( false );
                member = myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer.deserialize(ns1_ImageData_QNAME, reader, context);
                requiredElements.remove("ImageData");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setImageData((member == null)? null : ((com.aasc.erp.carrier.stampsws.proxy.ArrayOfBase64Binary)member).toArray());
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.CreateIndiciumResponse instance = (com.aasc.erp.carrier.stampsws.proxy.CreateIndiciumResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getImageData() != null) {
            myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer.setNullable( false );
            com.aasc.erp.carrier.stampsws.proxy.ArrayOfBase64Binary instanceGetImageData_arrayWrapper = (instance.getImageData() == null) ? null : new com.aasc.erp.carrier.stampsws.proxy.ArrayOfBase64Binary(instance.getImageData());
            myns1_ArrayOfBase64Binary__ArrayOfBase64Binary_LiteralSerializer.serialize(instanceGetImageData_arrayWrapper, ns1_ImageData_QNAME, null, writer, context);
        }
    }
}
