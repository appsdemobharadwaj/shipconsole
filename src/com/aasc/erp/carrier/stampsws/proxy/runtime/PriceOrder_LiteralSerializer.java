...
public class PriceOrder_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_ShippingAddress_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "ShippingAddress");
    ...
    public PriceOrder_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PriceOrder_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.stampsws.proxy.PriceOrder instance = new com.aasc.erp.carrier.stampsws.proxy.PriceOrder();
        ...
        requiredElements.add("ShippingAddress");
        for (int memberIndex = 0; memberIndex <5; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_ShippingAddress_QNAME))) {
                myns1_Address__Address_LiteralSerializer.setNullable( false );
                member = myns1_Address__Address_LiteralSerializer.deserialize(ns1_ShippingAddress_QNAME, reader, context);
                requiredElements.remove("ShippingAddress");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setShippingAddress((com.aasc.erp.carrier.stampsws.proxy.Address)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.PriceOrder instance = (com.aasc.erp.carrier.stampsws.proxy.PriceOrder)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns1_Address__Address_LiteralSerializer.setNullable( false );
        myns1_Address__Address_LiteralSerializer.serialize(instance.getShippingAddress(), ns1_ShippingAddress_QNAME, null, writer, context);
    }
}
