...
public class CapabilitiesV4_InterfaceSOAPSerializer extends InterfaceSerializerBase implements Initializable {
    ...
    private CombinedSerializer myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer;
    
    public CapabilitiesV4_InterfaceSOAPSerializer(QName type, boolean encodeType, boolean isNullable, SOAPVersion soapVersion) {
        super(type, encodeType, isNullable, soapVersion);
    }
    public CapabilitiesV4_InterfaceSOAPSerializer(QName type, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        CombinedSerializer interfaceSerializer = new com.aasc.erp.carrier.stampsws.proxy.runtime.CapabilitiesV4_LiteralSerializer(type, ENCODE_TYPE);
        myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer = interfaceSerializer.getInnermostSerializer();
        if (myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer instanceof Initializable) {
            ((Initializable)myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer).initialize(registry);
        }
    }
    ...
    public java.lang.Object doDeserialize(QName name, XMLReader reader,
        ...
        } else if (elementType == null || elementType.equals(myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer.getXmlType())) {
            java.lang.Object obj = myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer.deserialize(name, reader, context);
            return obj;
        }
    ...
    public void doSerializeInstance(java.lang.Object obj, QName name, SerializerCallback callback,
        ...
        com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV4 instance = (com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV4)obj;
        ...
        if (obj instanceof com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV7) {
            ...
            myns1_CapabilitiesV4__CapabilitiesV4_LiteralSerializer.serialize(obj, name, callback, writer, context);
        }
    }
}
