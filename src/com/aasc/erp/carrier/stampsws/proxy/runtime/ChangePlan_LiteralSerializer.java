...
public class ChangePlan_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    public ChangePlan_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ChangePlan_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.stampsws.proxy.ChangePlan instance = new com.aasc.erp.carrier.stampsws.proxy.ChangePlan();
        ...
        requiredElements.add("PromoCode");
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_PlanId_QNAME))) {
                ...
                member = myns2__int__java_lang_Integer_Int_Serializer.deserialize(ns1_PlanId_QNAME, reader, context);
                requiredElements.remove("PlanId");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setPlanId((java.lang.Integer)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.ChangePlan instance = (com.aasc.erp.carrier.stampsws.proxy.ChangePlan)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getPlanId() != null) {
            myns2__int__java_lang_Integer_Int_Serializer.setNullable( false );
            myns2__int__java_lang_Integer_Int_Serializer.serialize(instance.getPlanId(), ns1_PlanId_QNAME, null, writer, context);
        }
        myns2_string__java_lang_String_String_Serializer.setNullable( false );
