...
public class PlaceOrderResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_StoreOrderId_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "StoreOrderId");
    ...
    public PlaceOrderResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public PlaceOrderResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.stampsws.proxy.PlaceOrderResponse instance = new com.aasc.erp.carrier.stampsws.proxy.PlaceOrderResponse();
        ...
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_StoreOrderId_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_StoreOrderId_QNAME, reader, context);
                requiredElements.remove("StoreOrderId");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setStoreOrderId((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.PlaceOrderResponse instance = (com.aasc.erp.carrier.stampsws.proxy.PlaceOrderResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getStoreOrderId() != null) {
            myns2_string__java_lang_String_String_Serializer.setNullable( false );
            myns2_string__java_lang_String_String_Serializer.serialize(instance.getStoreOrderId(), ns1_StoreOrderId_QNAME, null, writer, context);
        }
