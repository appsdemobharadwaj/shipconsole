...
public class CreateScanFormResponse_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_ScanFormId_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "ScanFormId");
    private static final QName ns1_Url_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "Url");
    
    public CreateScanFormResponse_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public CreateScanFormResponse_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.stampsws.proxy.CreateScanFormResponse instance = new com.aasc.erp.carrier.stampsws.proxy.CreateScanFormResponse();
        ...
        requiredElements.add("ScanFormId");
        ...
        for (int memberIndex = 0; memberIndex <3; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_ScanFormId_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_ScanFormId_QNAME, reader, context);
                requiredElements.remove("ScanFormId");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setScanFormId((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.CreateScanFormResponse instance = (com.aasc.erp.carrier.stampsws.proxy.CreateScanFormResponse)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        myns2_string__java_lang_String_String_Serializer.setNullable( false );
        myns2_string__java_lang_String_String_Serializer.serialize(instance.getScanFormId(), ns1_ScanFormId_QNAME, null, writer, context);
        myns2_string__java_lang_String_String_Serializer.setNullable( false );
