...
public class ChangePassword_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_OldPassword_QNAME = new QName("http://stamps.com/xml/namespace/2014/07/swsim/swsimv37", "OldPassword");
    ...
    public ChangePassword_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public ChangePassword_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.aasc.erp.carrier.stampsws.proxy.ChangePassword instance = new com.aasc.erp.carrier.stampsws.proxy.ChangePassword();
        ...
        for (int memberIndex = 0; memberIndex <4; memberIndex++) {
            ...
            if ((reader.getState() == XMLReader.START) && (matchQName(elementName, ns1_OldPassword_QNAME))) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                member = myns2_string__java_lang_String_String_Serializer.deserialize(ns1_OldPassword_QNAME, reader, context);
                requiredElements.remove("OldPassword");
                if (member == null) {
                    throw new DeserializationException("literal.unexpectedNull",DeserializationException.FAULT_CODE_CLIENT);
                }
                instance.setOldPassword((java.lang.String)member);
                context.setXmlFragmentWrapperName( null );
                reader.nextElementContent();
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.aasc.erp.carrier.stampsws.proxy.ChangePassword instance = (com.aasc.erp.carrier.stampsws.proxy.ChangePassword)obj;
    ...
    public void doSerialize(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        if (instance.getOldPassword() != null) {
            myns2_string__java_lang_String_String_Serializer.setNullable( false );
            myns2_string__java_lang_String_String_Serializer.serialize(instance.getOldPassword(), ns1_OldPassword_QNAME, null, writer, context);
        }
        myns2_string__java_lang_String_String_Serializer.setNullable( false );
