...
public class CapabilitiesV2_InterfaceSOAPSerializer extends InterfaceSerializerBase implements Initializable {
    ...
    private CombinedSerializer myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer;
    
    public CapabilitiesV2_InterfaceSOAPSerializer(QName type, boolean encodeType, boolean isNullable, SOAPVersion soapVersion) {
        super(type, encodeType, isNullable, soapVersion);
    }
    public CapabilitiesV2_InterfaceSOAPSerializer(QName type, boolean encodeType) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        CombinedSerializer interfaceSerializer = new com.aasc.erp.carrier.stampsws.proxy.runtime.CapabilitiesV2_LiteralSerializer(type, ENCODE_TYPE);
        myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer = interfaceSerializer.getInnermostSerializer();
        if (myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer instanceof Initializable) {
            ((Initializable)myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer).initialize(registry);
        }
    }
    ...
    public java.lang.Object doDeserialize(QName name, XMLReader reader,
        ...
        } else if (elementType == null || elementType.equals(myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer.getXmlType())) {
            java.lang.Object obj = myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer.deserialize(name, reader, context);
            return obj;
        }
    ...
    public void doSerializeInstance(java.lang.Object obj, QName name, SerializerCallback callback,
        ...
        com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV2 instance = (com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV2)obj;
        ...
        if (obj instanceof com.aasc.erp.carrier.stampsws.proxy.CapabilitiesV7) {
            ...
            myns1_CapabilitiesV2__CapabilitiesV2_LiteralSerializer.serialize(obj, name, callback, writer, context);
        }
    }
}
