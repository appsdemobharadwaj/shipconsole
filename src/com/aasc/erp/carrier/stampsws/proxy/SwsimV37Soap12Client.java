...
public class SwsimV37Soap12Client {
    private com.aasc.erp.carrier.stampsws.proxy.SwsimV37Soap _port;
    
    public SwsimV37Soap12Client() throws Exception {
        ServiceFactory factory = ServiceFactory.newInstance();
        _port = ((com.aasc.erp.carrier.stampsws.proxy.SwsimV37)factory.loadService(com.aasc.erp.carrier.stampsws.proxy.SwsimV37.class)).getSwsimV37Soap12();
    }
    ...
    public static void main(String[] args) {
        try {
            com.aasc.erp.carrier.stampsws.proxy.SwsimV37Soap12Client myPort = new com.aasc.erp.carrier.stampsws.proxy.SwsimV37Soap12Client();
